...
import { QueryTextArea, Typing } from "@/components";
import { useLocation } from "@/providers";
import type { ChatHistoryType, ErrorStateType } from "@/types";
...
/**
 * Chat input container that manages query state, validation, and submission.
 * Includes the text area, typing indicator, and send/new-chat controls.
 */
