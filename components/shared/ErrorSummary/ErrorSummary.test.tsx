...
describe("ErrorSummary", () => {
  ...
  it("renders the default title", () => {
    render(
      <ErrorSummary errors={[{ text: "Enter your full name", href: "#" }]} />,
    );
  ...
  it("renders a custom title", () => {
    render(
      <ErrorSummary
        ...
        errors={[{ text: "Enter your full name", href: "#" }]}
      />,
    );
  ...
  it("renders all error messages as list items", () => {
    const errors = [
      { text: "Enter your full name", href: "#" },
      { text: "Enter a valid email address", href: "#" },
    ];
  ...
  it("has role alert for accessibility", () => {
    render(<ErrorSummary errors={[{ text: "Test error", href: "#" }]} />);
